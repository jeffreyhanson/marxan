...
```{r plot_data, results="hide", eval=FALSE}
# plot planning units
plot(taspu)
...
```{r view_pu_data, results="hide", eval=FALSE}
...
```{r run_marxan, results="hide", eval=FALSE}
...
```{r make_geoplots, results="hide", eval=FALSE}
...
```{r make_dotcharts, results="hide", eval=FALSE}
...
```{r mv_analysis, results="hide", eval=FALSE}
...
```{r compare_solutions, results="hide", eval=FALSE}

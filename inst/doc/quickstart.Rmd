...
This data comes from the ['Introduction to Marxan'](http://marxan.net/courses.html). The `taspu` object stores data for the planning units, and the `tasinvis` object stores data for the 63 vegetation classes--the biodiversity features. Let's make some reserve systems and plot them.
...
Finally, let's use multivariate analyses to visualise compare the solutions in the second portfolio.
